...
public class MQClientAPIImpl {
    ...
    /**
     * 根据ProducerGroup获取Producer连接列表
     * @param likeGroupName 搜索相似的信息
     */
    public ProducerGroup getProducerGroupList(final String addr, final String likeGroupName,
                                                        final long timeoutMillis) throws RemotingConnectException, RemotingSendRequestException,
            RemotingTimeoutException, InterruptedException, MQBrokerException {
        // 添加虚拟运行环境相关的projectGroupPrefix
        ...
        RemotingCommand request =
                RemotingCommand.createRequestCommand(RequestCode.GET_PRODUCERGROUP_ACTIVE_LIST, requestHeader);
